...
export const tryNowBannerData = {
	title: 'Попробуйте интернет без границ уже сейчас',
	text: 'Защитите свои данные, получите максимальную скорость и полный доступ к любому контенту. Оформите премиум прямо сейчас и наслаждайтесь свободой в интернете! ',
	btnText: 'Попробовать за 19 руб.',
}

export const premiumTrialBannerData = {
	title: 'Cтань Premium сейчас и получи +30 дней бесплатно!',
